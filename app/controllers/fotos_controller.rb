class FotosController < ApplicationController
  ...
  private
    ...
    def foto_params
      params.require(:foto).permit(:foto_nombreArchivo, :foto_ruta, :foto_titulo, :foto_descripcion, :foto_entidadCodigo, :foto_entidad_id, :foto_portada, :foto_estadoRegistro)
    end
end
