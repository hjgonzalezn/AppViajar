class ModelosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @modelo.save
        format.html { redirect_to @modelo, notice: 'Modelo creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @modelo.update(modelo_params)
        format.html { redirect_to @modelo, notice: 'Modelo actualizado exitosamente.' }
  ...
  def destroy
    @modelo.destroy
    respond_to do |format|
      format.html { redirect_to modelos_url, notice: 'Modelo eliminado exitosamente.' }
  ...
  private
    ...
    def modelo_params
      params.require(:modelo).permit(:mdl_codigo, :mdl_nombre, :mdl_estadoRegistro)
    end
end
