class VehiculosController < ApplicationController
  ...
  private
    ...
    def vehiculo_params
      params.require(:vehiculo).permit(:vehi_tipo, :vehi_modeloCodigo, :vehi_medioCodigo, :vehi_nombre, :vehi_matricula, :vehi_propietarioId, :vehi_tipoPropietario, :vehi_sucursalEmpresaPropId, :vehi_capacPesoMaximo, :vehi_capacPesoPasajeros, :vehi_capacCargaBodega, :vehi_capacPasajeros, :vehi_estadoRegistro)
    end
end
