...
class ModelosControllerTest < ActionController::TestCase
  ...
  test "should create modelo" do
    assert_difference('Modelo.count') do
      post :create, modelo: { mdl_codigo: @modelo.mdl_codigo, mdl_estadoRegistro: @modelo.mdl_estadoRegistro, mdl_nombre: @modelo.mdl_nombre }
    end
  ...
  test "should update modelo" do
    patch :update, id: @modelo, modelo: { mdl_codigo: @modelo.mdl_codigo, mdl_estadoRegistro: @modelo.mdl_estadoRegistro, mdl_nombre: @modelo.mdl_nombre }
    assert_redirected_to modelo_path(assigns(:modelo))
  end
